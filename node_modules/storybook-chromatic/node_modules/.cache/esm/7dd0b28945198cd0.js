_451‍.x([["addShimsToJSDOM",()=>addShimsToJSDOM]]);/* eslint-disable @typescript-eslint/no-empty-function, max-classes-per-file, no-param-reassign */
...
const svgElements = [
  ...
  svgElements.forEach(e => {
    if (!window[e]) {
      ...
      const Value = _451‍.u(eval(_451‍.c(`(class ${e} extends window.HTMLElement {})`)));
