let execSync,setupDebug,gql,dedent,log;_451‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["getBaselineCommits",()=>getBaselineCommits]]);_451‍.w("child_process",[["execSync",["execSync"],function(v){execSync=v}]]);_451‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_451‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_451‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_451‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);
