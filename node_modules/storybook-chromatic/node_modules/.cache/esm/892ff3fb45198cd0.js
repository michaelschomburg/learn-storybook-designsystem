let envCi,dedent,setupDebug,getCommit,getBranch,log;_451‍.x([["debug",()=>debug],["getCommitAndBranch",()=>getCommitAndBranch]]);_451‍.w("env-ci",[["default",["envCi"],function(v){envCi=v}]]);_451‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_451‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_451‍.w("./git",[["getCommit",["getCommit"],function(v){getCommit=v}],["getBranch",["getBranch"],function(v){getBranch=v}]]);_451‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);
