      ...
      child.on('close', () => {
        if (!resolved) {
          reject(new Error(`Script failed to start: ${output}\n`));
               ...
               async function startApp({ scriptName, commandName, args, url, inheritStdio }) {
  const env = {
    ...process.env,
